...
--
-- Host: localhost    Database: toexpress
-- ------------------------------------------------------
...
INSERT INTO `chofer` VALUES (187097126,'Erick Sanhueza','2019-06-04 22:38:19','2019-06-04 22:38:19','2019-06-04 22:38:19');
...
INSERT INTO `cliente` VALUES ('10376117-4','CLIENTE DE PRUEBAS 3','2019-06-07 22:02:35','2019-06-07 22:02:35'),('8145730-1','CLIENTE DE PRUEBAS 1','2019-06-04 23:04:16','2019-06-04 23:04:16'),('C8145730-1','CLIENTE DE PRUEBAS 2','2019-06-07 22:02:12','2019-06-07 22:02:12');
...
INSERT INTO `documento` VALUES (1,33,12345,'2019-06-04 23:04:19',540000,'10376117-4','8145730-1'),(2,52,11111,'2019-06-07 22:02:49',100000,'10376117-4','10376117-4'),(3,33,22222,'2019-06-07 22:03:50',120000,'10376117-4','10376117-4');
...
INSERT INTO `documento_en_ruta` VALUES (1,1,NULL,NULL),(2,1,NULL,NULL),(3,1,NULL,NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`toexpress`@`localhost`*/ /*!50003 TRIGGER `ins_film` AFTER INSERT ON `film` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`toexpress`@`localhost`*/ /*!50003 TRIGGER `upd_film` AFTER UPDATE ON `film` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`toexpress`@`localhost`*/ /*!50003 TRIGGER `del_film` AFTER DELETE ON `film` FOR EACH ROW BEGIN
...
INSERT INTO `rol` VALUES (1,'ROL_CHOFER');
...
INSERT INTO `ruta` VALUES (1,'RUTA DEV 1','MAÑANA',187097126),(2,'RUTA TARDE','TARDE',187097126);
...
INSERT INTO `user` VALUES (187097126,'Erick Sanhueza','test','2019-06-19 22:06:51','2019-06-19 22:06:51',1);
...
/*!50013 DEFINER=`toexpress`@`localhost` SQL SECURITY INVOKER */
...
/*!50001 SET collation_connection      = utf8_general_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`toexpress`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2019-06-22 17:56:10
