...
<head>
    ...
    <script src="../js/vehiculos/loadData.js"></script>
</head>
                    ...
                    <ul class="nav navbar-top-links pull-right">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                ...
                                <div class="username hidden-xs">Bodeguero User</div>
                            </a>
        ...
        <div class="boxed">
          ...
          <div id="content-container">
              <div id="page-head">
                  ...
                  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                  <div id="page-title">
                      <h1 class="page-header text-overflow">Vehículos Disponibles en el Sistema</h1>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="panel">
                      <div id="demo-custom-toolbar2" class="table-toolbar-left">
                          <button id="demo-dt-addrow-btn" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="demo-pli-plus"></i> Agregar Vehículo</button>
                      </div>
           ...
           <div class="modal-content">
             ...
             <form id="frmAgregar" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
               <div class="form-group">
                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="patente">Patente <span class="required">*</span>
                 </label>

                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="patente" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Patente">
                 </div>
               </div>
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="marca" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Modelo">
                 </div>
               </div>
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="modelo" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Modelo">
                 </div>
               </div>
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="ano" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Año">
                 </div>
               </div>
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               <div class="modal-header">
                 ...
                 <h4 class="modal-title" id="modalEliminarLabel">Eliminar Vehículo</h4>
               </div>
               <div class="modal-body">
                 ¿Está seguro de eliminar el vehiculo seleccionado?<strong data-name=""></strong>
               </div>
               <div class="modal-footer">
     		...
     		<div class="modal fade" id="myModalEditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabelEdit" aria-hidden="true">
     				<div class="modal-dialog">
     					<div class="modal-content">
     						<div class="modal-header">
     							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
     							<h4 class="modal-title" id="myModalLabelEdit">Editar Vehículo Seleccionado</h4>
     						</div>
     						<div class="modal-body">
