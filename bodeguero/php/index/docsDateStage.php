...
$query = "select count(CAST(documento.fechaEmision as DATE)) as cantidad, CAST(documento.fechaEmision as DATE) as fecha from documento group by CAST(documento.fechaEmision as DATE)";
