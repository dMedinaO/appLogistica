...
<head>
    ...
    <script src="../js/ruta/loadDocumentoFin.js"></script>
    <script src="../js/ruta/loadDetalleRutaFin.js"></script>
                        ...
                        <div class="pad-all ">
                            ...
                            <div class="panel-body">
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <span class="text-main text-semibold">Información Pedido</span>
                                  </td>
                                  <td>
                                    <span class="text-main">En esta sección encontrarás información de los documentos en la ruta junto con el detalle de recepción. No se puede alterar la información.</span>
                                  </td>
                                 </tr>

                                  <tr>
                                      <td>
                                        <span class="text-main text-semibold">Documento Respaldo</span>
                                      </td>
                                      <td>
                                          <span class="text-main">El documento de respaldo corresponde a una imagen asociada a la entrega del producto, la cual se asocia a una firma del cliente o recepcionista.</span>
                                      </td>
                                  </tr>
