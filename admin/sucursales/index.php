...
<head>
    ...
    <script src="../js/sucursales/loadData.js"></script>
                  ...
                  <div id="page-title">
                      <h1 class="page-header text-overflow">
                        <?php
                          ...
                          echo "Sucursales para Cliente $client";
                        ?>
                      </h1>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="panel">
                      <div id="demo-custom-toolbar2" class="table-toolbar-left">
                          <button id="demo-dt-addrow-btn" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="demo-pli-plus"></i> Agregar Sucursal</button>
                      </div>
             ...
             <form id="frmAgregar" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="region" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Región">
                 </div>
               </div>
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               <div class="modal-header">
                 ...
                 <h4 class="modal-title" id="modalEliminarLabel">Eliminar Sucursal</h4>
               </div>
               <div class="modal-body">
                 ¿Está seguro de eliminar la Sucursal seleccionada?<strong data-name=""></strong>
               </div>
               <div class="modal-footer">
     		...
     		<div class="modal fade" id="myModalEditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabelEdit" aria-hidden="true">
     				<div class="modal-dialog">
     					<div class="modal-content">
     						<div class="modal-header">
     							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
     							<h4 class="modal-title" id="myModalLabelEdit">Editar Sucursal Seleccionada</h4>
     						</div>
     						<div class="modal-body">
