...
<head>
    ...
    <script src="../js/bodega/loadData.js"></script>
</head>
        ...
        <div class="boxed">
          ...
          <div id="content-container">
              <div id="page-head">
                  ...
                  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                  <div id="page-title">
                      <h1 class="page-header text-overflow">Bodegas Disponibles en el Sistema</h1>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="panel">
                      <div id="demo-custom-toolbar2" class="table-toolbar-left">
                          <button id="demo-dt-addrow-btn" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="demo-pli-plus"></i> Agregar Bodega</button>
                      </div>
                        ...
                        <table id="bodegaData" class="table table-striped table-bordered" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              ...
                              <th class="min-tablet">Provincia</th>
         ...
         <div class="modal-dialog">
           <div class="modal-content">
             <div class="modal-header">
               ...
               <h4 class="modal-title" id="myModalLabel">Agregar Nueva Bodega</h4>
             </div>
             ...
             <form id="frmAgregar" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="provincia" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Provincia">
                 </div>
               </div>
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="comuna" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Comuna">
                 </div>
               </div>
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="ciudad" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Ciudad">
                 </div>
               </div>
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="direccion" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese Dirección">
                 </div>
               </div>
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               <div class="modal-header">
                 ...
                 <h4 class="modal-title" id="modalEliminarLabel">Eliminar Bodega</h4>
               </div>
               <div class="modal-body">
                 ¿Está seguro de eliminar la bodega seleccionada?<strong data-name=""></strong>
               </div>
               <div class="modal-footer">
     		...
     		<div class="modal fade" id="myModalEditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabelEdit" aria-hidden="true">
     				<div class="modal-dialog">
     					<div class="modal-content">
     						<div class="modal-header">
     							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
     							<h4 class="modal-title" id="myModalLabelEdit">Editar Bodega Seleccionada</h4>
     						</div>
     						<div class="modal-body">
