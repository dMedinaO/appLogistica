...
<head>
    ...
    <script src="../js/bodegueros/loadData.js"></script>
    <script src="../js/bodegueros/loadDataBodega.js"></script>
</head>
        ...
        <div class="boxed">
          ...
          <div id="content-container">
              <div id="page-head">
                  ...
                  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                  <div id="page-title">
                      <h1 class="page-header text-overflow">Bodegueros Disponibles en el Sistema</h1>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="panel">
                      <div id="demo-custom-toolbar2" class="table-toolbar-left">
                          <button id="demo-dt-addrow-btn" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="demo-pli-plus"></i> Agregar Bodeguero</button>
                      </div>
                      ...
                      <div class="panel-body">
                        <table id="bodegaData" class="table table-striped table-bordered" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              <th class="min-tablet">Bodeguero</th>
         ...
         <div class="modal-dialog">
           <div class="modal-content">
             <div class="modal-header">
               ...
               <h4 class="modal-title" id="myModalLabel">Agregar Nuevo Bodeguero</h4>
             </div>
             ...
             <form id="frmAgregar" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
               <div class="form-group">
                 ...
                 <div class="col-md-9 col-sm-9 col-xs-12">
                   <input type="text" id="name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Ingrese nombre bodeguero">
                 </div>
               </div>
               ...
               <div class="form-group">
 								<label class="control-label col-md-3 col-sm-3 col-lg-3" for="bodega">Categoría <span class="required">*</span>
 								</label>
 								<div class="col-md-7 col-sm-7 col-lg-7 col-xs-12">
 									<div class="selector-bodega">
 										<select id="bodega" class="form-control" required>
 										</select>
 									</div>
 								</div>
 							</div>
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               <div class="modal-header">
                 ...
                 <h4 class="modal-title" id="modalEliminarLabel">Eliminar Bodeguero</h4>
               </div>
               <div class="modal-body">
                 ¿Está seguro de eliminar el bodeguero seleccionado?<strong data-name=""></strong>
               </div>
               <div class="modal-footer">
     		...
     		<div class="modal fade" id="myModalEditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabelEdit" aria-hidden="true">
     				<div class="modal-dialog">
     					<div class="modal-content">
     						<div class="modal-header">
     							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
     							<h4 class="modal-title" id="myModalLabelEdit">Editar Bodeguero Seleccionado</h4>
     						</div>
     						<div class="modal-body">
