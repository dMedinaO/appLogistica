...
<head>
    ...
    <link href="../premium/icon-sets/icons/line-icons/premium-line-icons.min.css" rel="stylesheet">
		...
		<script src="../js/mailing/contactUs.js"></script>
                        ...
                        Contactar al administrador
											...
											<div class="panel-body">
													<div class="fixed-fluid">
															<div class="fixed-md-250 pull-sm-left fixed-right-border">
																	...
																	<!-- Profile Details -->
																	<p class="pad-ver text-main text-sm text-uppercase text-bold">Datos</p>
																	<ul>
																		<li>
																		...
																		<li>
																			...
																			<span class="menu-title">correo@gmail.com</span>
																		</li>
																		<br>
																		<li>
																			<i class="fa fa fa-phone icon-lg icon-fw"></i>
																			<span class="menu-title">+569 11223344</span>
																		</li>
																	</ul>
															...
															<div class="fluid">
																...
																<div class="panel">
																	<div class="panel-title">
																			Envía un Mensaje (Llegará como notificación al celular del chofer)
																	</div>
                                    ...
                                    <form>
                                      ...
                                      <div class="form-group">
                                        <label for="chofer">Seleccione al Chofer</label>
                                        <select class="form-control" id="chofer">
                                          <option>Chofer 01</option>
                                          <option>Chofer 02</option>
                                          <option>Chofer 03</option>
                                          <option>Chofer 04</option>
                                          <option>Chofer 05</option>
                                        </select>
                                      </div>
                                      <div class="form-group">
                                        <label for="titulo">Título del Mensaje</label>
                                        <input type="input" class="form-control" id="titulo" placeholder="Ingrese el título del mensaje">
                                      </div>

                                      <div class="form-group">
                                        <label for="asunto">Asunto del Mensaje</label>
                                        <input type="input" class="form-control" id="asunto" placeholder="Ingrese el Asunto del mensaje">
                                      </div>
