        ...
        setInterval(async function(){
            ...
            if (!recuperandoDatos){
                ...
                result.map(function(d){
                    ...
                    if (typeof choferes[d.rut].marcador != 'undefined'){
                        if (choferes[d.rut].lastUpdate.isBefore(last)){
                            choferes[d.rut].lastUpdate = last;
                            capaMarcadores.removeLayer(choferes[d.rut].marcador);
    ...
    async function iniciarListadoChoferes(){
        ...
        document.getElementById('deshabilitar-choferes').addEventListener('click', function(){
            for (const [rut, d] of Object.entries(choferes)) {
                ...
                if (typeof d.marcador != 'undefined' && capaMarcadores.hasLayer(d.marcador)){
